                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/setting') }}">
                            ...
                            <div class="form-group{{ $errors->has('site') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="site" type="text" class="form-control" name="site" value="{{user()->settings['site']}}" required>
                            ...
                            <div class="form-group{{ $errors->has('github') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="github" type="text" class="form-control" name="github" value="{{user()->settings['github']}}" required>
